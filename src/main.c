...
DISPLAY_DEF_BG_BUFFER(disp1, 240, 240, IMAGE_FORMAT_RGB444_BPP);
DISPLAY_DEF_BG_BUFFER(disp2, 240, 240, IMAGE_FORMAT_RGB444_BPP);
DISPLAY_DEF_BG_BUFFER(dips3, 240, 240, IMAGE_FORMAT_RGB444_BPP);
...
uint8_t output_buffer[IMAGE_BUFFER_SIZE(240, 240, IMAGE_FORMAT_RGB444_BPP)];
